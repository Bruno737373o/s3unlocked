	...
	dbglistobj Obj_AIZRideVine,		Map_AIZRideVine,		 $88, $41, make_art_tile(ArtTile_AIZSwingVine,0,0)
	dbglistobj Obj_AIZGiantRideVine,	Map_AIZRideVine,		  $F, $41, make_art_tile(ArtTile_AIZSwingVine,0,0)
