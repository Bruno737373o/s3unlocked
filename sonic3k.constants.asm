...
Status_Invincible   = 1
Status_SpeedShoes   = 2
Status_CombineRing  = 3				; Liliam: Encore mode - combine ring
Status_FireShield   = 4
Status_LtngShield   = 5
Status_BublShield   = 6
...
ArtTile_SStage_GBSArrow               = $07FC	; Liliam: special stage - add extra characters
...
ArtTile_SStage_Shadow                 = $07EC	; Liliam: special stage - add extra characters
;ArtTile_SStage_Shadow                = $07A0	;
ArtTile_SStage_Player2_Tail           = $079F	; Liliam: special stage - add extra characters
;ArtTile_SStage_Player2_Tail          = $07B0	;
ArtTile_SStage_Player1                = $07D4
ArtTile_SStage_Player2                = $07A8	; Liliam: special stage - add extra characters
...
ArtTile_Continue_Misc                 = $00B2	; Liliam: ported from S3 - restore continue font
;ArtTile_Continue_Misc                = $008C	;
ArtTile_Continue_Icons                = $00FF	; Liliam: ported from S3 - restore continue font
;ArtTile_Continue_Icons               = $00D9	;
ArtTile_Continue_Text                 = $002A	; Liliam: ported from S3 - restore continue font
...
ArtTile_Ending_IslandLiftGfx          = $0310	; Liliam: ending - add extra characters
...
ArtTile_Ending_ANDKnuckles            = $029D	; Liliam: ending - add extra characters
;ArtTile_Ending_ANDKnuckles           = $03EF	;
ArtTile_Ending_Logo                   = $026E	; Liliam: ending - add extra characters
...
ArtTile_AIZSwingVine                  = $040F	; Liliam: use high precision sine tables for AIZ vines
;ArtTile_AIZSwingVine                 = $041B	;
ArtTile_AIZBackgroundTree             = $0500	; Liliam: use high precision sine tables for AIZ vines
;ArtTile_AIZBackgroundTree            = $0438	;
ArtTile_AIZ2FloatingPlatform          = $0440
ArtTile_AIZ2BridgePost                = $0488	; Liliam: use high precision sine tables for AIZ vines
...
ArtTile_MHZKnuxSwitch                 = $03FE	; Liliam: cutscene knux - use level art for MHZ2 switch
...
ArtTile_DDZMisc                       = $0154	; Liliam: use level art for Doomsday objects
...
ArtTile_EnemyScore                    = $05E4	; Liliam: Encore mode - player swap
ArtTile_StarPost                      = $05EA	;
...
ArtTile_Shield                        = $079C
ArtTile_CombineRing                   = $07AC	; Liliam: Encore mode - combine ring
